...
public class MainActivity extends AppCompatActivity implements VideoAdapter.VideoClicklInterface{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoRV=findViewById(R.id.RVideos);
        videoRModelArrayList= new ArrayList<>();
        videoAdapter=new VideoAdapter(videoRModelArrayList,this,this::onVideoClick);
        ...
        if(cursor !=null && cursor.moveToFirst())
        {
            do {
               ...
               Bitmap videoThumbnail= ThumbnailUtils.createVideoThumbnail(videoPath,MediaStore.Images.Thumbnails.MINI_KIND);
                ...
                videoRModelArrayList.add(new VideoRModel(videoTitle,videoPath,videoThumbnail));
    ...
    public void onVideoClick(int position) {
        ...
        i.putExtra("videoName",videoRModelArrayList.get(position).getVideoName());
        i.putExtra("videoPath",videoRModelArrayList.get(position).getVideoPath());
        startActivity(i);
